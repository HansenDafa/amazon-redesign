  ...
  return (
    <main className="w-11/12 2xl:w-10/12 mx-auto my-10 relative">
      ...
      <section className="w-full my-20 flex flex-col gap-8">
        ...
        <section className="flex flex-col w-full gap-12">
          <section className="w-full h-fit flex items-center gap-6">
            <ImageCard src={IMG1} className={"aspect-square relative w-full h-full"}>50% Discount on Watches</ImageCard>
            <ImageCard src={IMG2} className={"aspect-square relative w-full h-full"}>40% Discount on Headphones</ImageCard>
            <ImageCard src={IMG3} className={"aspect-square relative w-full h-full"}>30% Discount on Televisions</ImageCard>
            <ImageCard src={IMG4} className={"aspect-square relative w-full h-full"}>20% Discount on Pans</ImageCard>
          </section>
      ...
      <section className="w-full my-20 flex flex-col gap-8">
        ...
        <section className="flex flex-col w-full gap-12">
          <section className="w-full h-fit flex items-center gap-6">
            <ImageCard
              src={SHOPIMG1}
              className={"aspect-[6/7] relative w-full h-full"}
            >
            Technologies
            </ImageCard>
            <ImageCard src={SHOPIMG2} className={"aspect-[6/7] relative w-full h-full"}>Cosmetics</ImageCard>
            <ImageCard src={SHOPIMG3} className={"aspect-[6/7] relative w-full h-full"}>Toys</ImageCard>
            <ImageCard src={SHOPIMG4} className={"aspect-[6/7] relative w-full h-full"}>Utilities</ImageCard>
          </section>
      ...
      <section className="w-full my-20 flex flex-col gap-8">
        ...
        <section className="flex flex-col w-full gap-12">
          ...
          <section className="flex gap-6 relative">
            ...
            <ImageCard src={PRODUCTIMG3} className={"aspect-[16/4]"}></ImageCard>
          </section>
        </section>
      </section>
      ...
      <section className="w-full my-20 flex flex-col gap-8">
        ...
        <ImageCard src={LEARNMOREIMG} className={"aspect-[16/5] relative w-full h-full"}>Ticket to Singapore for Certain Purchase</ImageCard>
      </section>
    </main>
  );
}
